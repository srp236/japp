...
import { Layout, Row, Col, Spin, notification, Card, Button } from 'antd';
...
import { GetUser } from '../firebase/firestore/auth_state_listener'
...
export default function Home() {
  ...
  currentUser?console.log('welcome'):router.push('/')
